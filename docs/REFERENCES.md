...
## 7. KF ADV — Hero Grid Reference

- URL: https://www.kfadv.it/
- 검토일: 2026-08-20
- 해결하려는 문제: 큰 타이포그래피, 넓은 여백과 소규모 정보 블록을 하나의 Hero 안에서 긴장감 있게 연결하는 방법
- 차용할 원칙: 화면을 지배하는 문구, 비대칭 그리드, 기능적인 상단 내비게이션, 본문 정보와 Visual Voice의 명확한 크기 대비
- 브랜드 적용: `OBSERVE. CONNECT. MAKE IT USEFUL.`을 큰 Visual Voice로 사용하고, 한글 슬로건과 설명은 절제된 Information Voice로 배치한다.
- 차용하지 않을 요소: 프리즘 형태의 3D 오브젝트, 사이트 고유 로고와 메뉴 형태, 형광색 원형 UI, 장식 목적의 인터랙션
- 중앙 시각물이 필요하면 장식 오브젝트 대신 관찰 노트, 프로젝트 과정 또는 구조화 전후처럼 사고 과정을 증명하는 실제 자료를 사용한다.

## 8. Reference Review Checklist
