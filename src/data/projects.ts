...
export const projects: Project[] = [
  ...
  { id: "valros", title: "VR 콘텐츠 제작 소프트웨어 VARLOS Web VR Editor", categories: ["digital-products", "websites"], keywords: "Digital Products · Websites", summary: "웹에서 VR 시나리오를 만들고 VR 헤드셋(HMD)으로 체험하는 에디터의 UX·UI 디자인과 퍼블리싱을 담당했습니다.", client: "삼우이머션", period: "전체 개발 약 6개월 · 담당 작업 총 3주", roles: ["디자이너 · 웹 퍼블리셔"], theme: { accent: "#385dd9", accentText: "#385dd9", accentSurface: "#eef1f7", onAccent: "#ffffff" }, cover: assetPath("/images/projects/valros/cover_hero.webp"), listingCover: assetPath("/images/projects/valros/cover_small.webp") },
