  ...
  return <div className={styles.content}>
    ...
    <div className={`${styles.band} ${styles.gray}`}>
      <section className={styles.section}>
        <Heading label="상황" title="온라인 문의 경로가 부족했던 기존 웹사이트"><p>기존 웹사이트는 기술과 제품 소개에 집중되어 있어, 관심을 가진 방문자가 상담이나 협업을 요청할 경로가 부족했습니다.</p><p>문의는 주로 전화로 접수됐지만, 고객 응대 체계가 갖춰지지 않아 신속하고 전문적인 대응에 어려움이 있었습니다.</p></Heading>
      ...
      <section className={styles.section}>
        <Heading label="목표" title="기술에 대한 관심을 실제 비즈니스 문의로 연결한다."><p>도입·데모·기술 협업을 검토하는 방문자가 목적에 맞는 문의를 남기도록 설계하고,</p><p>접수된 정보를 담당자가 확인하여 후속 상담으로 이어갈 수 있는 기반을 마련하는 것에 집중했습니다.</p></Heading>
    ...
    <div className={styles.band}>
      <section className={styles.section}>
        <Heading label="개선" title="기술과 제품을 쉽게 이해할 수 있도록 콘텐츠·디자인 재구성"><p>원페이지에 모여 있던 정보를 제품·서비스·산업 등 주제별 페이지로 나누고, 방문자가 필요한 정보를 찾아 도입 적합성을 판단할 수 있도록 콘텐츠를 구성했습니다.</p><p>각 페이지의 정보 위계와 시각 디자인을 새롭게 정리해, 회사의 기술과 솔루션을 일관된 방식으로 전달했습니다.</p></Heading>
      ...
      <section className={styles.section}>
        <Heading label="" title="어떤 페이지에서든 문의할 수 있도록 CTA 구성"><p>공통 내비게이션과 각 페이지 하단에 문의 버튼을 배치해, 정보를 탐색하는 중에도 내용을 모두 읽은 뒤에도 문의로 이어질 수 있도록 했습니다.</p><p>문의 페이지에서는 도입·데모, 기술 협업, 투자 등 목적에 맞는 유형을 선택하고 필요한 정보를 남기도록 구성했습니다.</p></Heading>
      ...
      <section className={styles.section}>
        <Heading label="" title="기본 질문은 문의 전에 확인할 수 있도록 FAQ 추가"><p>장비 호환, 기존 데이터 활용, 도입 기간과 비용 등 자주 묻는 내용을 문의 목적별로 정리했습니다.</p><p>방문자가 필요한 정보를 먼저 확인할 수 있도록 하고,<br />담당자는 고객의 구체적인 상황에 맞춘 상담에 집중할 수 있도록 했습니다.</p></Heading>
        <div className={styles.inset}><WebsiteImage name="faq" width={2254} height={1583} alt="도입·데모, 기술 협업, 채용 지원 목적별 자주 묻는 질문" enlarge /></div>
      </section>
      <section className={styles.section}>
        <Heading label="" title="빠른 응대와 체계적인 관리를 위한 알림·데이터 관리 기능 구현"><p>문의가 등록되면 담당자에게 알림을 보내 빠르게 확인하고 응대할 수 있도록 했습니다.</p><p>문의와 채용 지원 정보는 데이터베이스에 저장하고 유형별로 구분해, 접수 내역을 체계적으로 관리할 수 있도록 구성했습니다.</p></Heading>
    ...
    <div className={`${styles.band} ${styles.gray}`}>
      <section className={styles.section}>
        <Heading label="결과" title="회사 소개 중심의 웹사이트를 비즈니스 문의로 이어지는 채널로"><p>콘텐츠와 디자인을 전면 재구성하고, 정보 탐색부터 문의 접수·관리까지 이어지는 흐름을 마련했습니다.</p><p>배포 이틀 만에 실제 비즈니스 고객의 문의가 접수되며, 새로운 문의 경로가 활용되는 것을 확인했습니다.</p></Heading>
    ...
    <div className={styles.band}>
      <section className={styles.section}>
        <Heading label="회고" title="비즈니스 목표를 콘텐츠와 디자인의 판단 기준으로"><p>이번 리뉴얼 프로젝트에서는 회사의 기술을 어떻게 보여줄지와 함께, 방문자가 무엇을 확인하고 어떤 행동으로 이어질지를 고민했습니다.</p><p>콘텐츠와 디자인, 문의 경로와 관리 기능을 함께 다루며 웹사이트의 역할을 후속 대응까지 연결해 보는 관점을 얻었습니다.</p></Heading>
